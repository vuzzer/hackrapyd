  ...
  t.exports = function (n) {
    var a = function a(t) {
      ...
      return t && t[e] || "";
        ...
        o = function o(t, e) {
      if (t) for (var n = t.length, a = 0; a < n; a++) {
        e(a, t[a]);
      }
    },
        c = function c(t, e, n) {
      ...
      var p = function p(t) {
        ...
        callbacks: {
          ...
          onNextItem: function onNextItem(t, e, n) {
            n();
          },
          onNavigateItem: function onNavigateItem(t, e, n) {
            n();
          }
        },
        template: {
          timelineItem: function timelineItem(t) {
          ...
          timelineStoryItem: function timelineStoryItem(t) {
          ...
          viewerItem: function viewerItem(t, e) {
            return '<div class="story-viewer">\n                    <div class="head">\n                      <div class="left">\n                        '.concat(u("backButton") ? '<a class="back">&lsaquo;</a>' : "", '\n\n                        <span class="item-preview">\n                          <img lazy="eager" class="profilePhoto" src="').concat(i(t, "photo"), '" />\n                        </span>\n\n                        <div class="info">\n                          <strong class="name">').concat(i(t, "name"), '</strong>\n                          <span class="time">').concat(i(t, "timeAgo"), '</span>\n                        </div>\n                      </div>\n\n                      <div class="right">\n                        <span class="time">').concat(i(e, "timeAgo"), '</span>\n                        <span class="loading"></span>\n                        <a class="close" tabIndex="2">&times;</a>\n                      </div>\n                    </div>\n\n                    <div class="slides-pointers">\n                      <div class="wrap"></div>\n                    </div>\n\n                    ').concat(u("paginationArrows") ? '<div class="slides-pagination">\n                          <span class="previous">&lsaquo;</span>\n                          <span class="next">&rsaquo;</span>\n                        </div>' : "", "\n                  </div>");
          },
          viewerItemPointer: function viewerItemPointer(t, e, n) {
            return '<span \n                    class="'.concat(e === t ? "active" : "", " ").concat(!0 === i(n, "seen") ? "seen" : "", '"\n                    data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n                      <b style="animation-duration:').concat("" === i(n, "length") ? "3" : i(n, "length"), 's"></b>\n                  </span>');
          },
          viewerItemBody: function viewerItemBody(t, e, n) {
            return '<div \n                    class="item '.concat(!0 === i(n, "seen") ? "seen" : "", " ").concat(e === t ? "active" : "", '"\n                    data-time="').concat(i(n, "time"), '" data-type="').concat(i(n, "type"), '" data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n                    ').concat("video" === i(n, "type") ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), '></video>\n                        <b class="tip muted">').concat(u("language", "unmute"), "</b>") : '<img loading="auto" class="media" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), " />\n                    "), "\n\n                    ").concat(i(n, "link") ? '<a onclick="paid(10)" class="tip link storypay btn-price"  href="'.concat(i(n, "link"), '" rel="noopener" target="_blank">\n                            ').concat(i(n, "linkText") && "" !== i(n, "linkText") ? i(n, "linkText") : u("language", "visitLink"), "\n                          </a>") : "", "\n                  </div>");
          }
        },
        language: {
        ...
        }, u("openEffect") && c.classList.add("with-effects"), u("rtl") && c.classList.add("rtl"), e = function e() {
      ...
      d.data = u("stories") || {}, d.internalData = {}, d.internalData.seenItems = I("seenItems") || {}, d.add = d.update = function (e, n) {
        var c,
            ...
            m = i(e, "items"),
            v = !1;
        if (m[0] && (v = m[0].preview || ""), !0 === d.internalData.seenItems[r] && (e.seen = !0), e.currentPreview = v, s) c = s;else {
