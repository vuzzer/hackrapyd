var ttt = {
  ...
  play : (id) => {
    ...
    function prodRed()
    {
      var pGame= document.getElementById("p-game");
    ...
    if (win !== null) {
      alert("WINNER - " + (win==0 ? "Player, Click on 'OK' to see your product reduction." : "Computer , try again."));
     
      if(win==0){
      var divGame= document.getElementById("ttt-game");
          divGame.style.display='none';
          document.getElementById("loading").style.display='block';
      var prinGame= document.getElementById("principle");
          prinGame.style.display='none';
      var welGame= document.getElementById("welGame");
      welGame.style.display='none';
      const prodSee = setTimeout(prodRed, 300);
      }
